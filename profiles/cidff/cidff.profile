...
/**
 * @file
 * Enables modules and site configuration for the CIDFF site installation.
 */
 ...
 */
function cidff_form_install_configure_form_alter(&$form, $form_state) {
  // Pre-populate the site name.
  $form['site_information']['site_name']['#default_value'] = 'CIDFF';
